...
In other words::
    ...
    git clone git@github.com:X00LA/nanorc.git ~/.nano

*Note - if you have any issues (ssh was not properly configured), alternatively use::

    git clone https://github.com/X00LA/nanorc.git ~/.nano
    
*System wide will look like so*::

    sudo git clone https://github.com/X00LA/nanorc.git /usr/share/nano-syntax-highlighting/
...
This is reported in `issue 52 <https://github.com/X00LA/nanorc/issues/52>`_
...
Finally, you can run an automatic installer using the following code::
    ...
    $ curl https://raw.githubusercontent.com/X00LA/nanorc/master/install.sh | sh

or alternatively::

    $ wget https://raw.githubusercontent.com/X00LA/nanorc/master/install.sh -O- | sh
